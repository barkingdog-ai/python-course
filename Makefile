...
run_api:
	python src/python_course/backend/api/run.py

run_app:
	python src/python_course/frontend/app/run.py
...
help:
	...
	@echo "run_api - run Uvicorn server"
	@echo "run_app - run streamlit server"
