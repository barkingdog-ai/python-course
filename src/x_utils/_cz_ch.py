...
def render_cherry(origin_branch_name: str = "") -> str:
    ...
    order_tree = changelog.order_changelog_tree(tree, CommitizenGitmojiCz.change_type_order)
    return changelog.render_changelog(order_tree, CommitizenGitmojiCz.template_loader, "CHANGELOG.md.j2")
